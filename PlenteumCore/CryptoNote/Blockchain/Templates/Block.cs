...
namespace Plenteum.CryptoNote.Blockchain
{
    ...
    public class Block
    {
        ...
        public string PreviousBlockHash
        {
            get
            {
                if (string.IsNullOrEmpty(_previousBlockHash) && Height > 0)
                {
        ...
        {
            if (Transaction.Hash != Constants.NULL_HASH)
            {
        ...
        internal void SetTransactions(IEnumerable<Transaction> Transactions)
        {
